...
## Basic Example
We have all the basic dependencies in `requirements.txt`, although none are really necessary if you change your implementation (`google-genai` for LM API calls, `dotenv` for .env loading, and `rich` for logging).
